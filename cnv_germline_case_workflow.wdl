...
workflow CNVGermlineCaseWorkflow {
    ...
    call data_transfer {
        input:
            ...
            genotyped_intervals_vcfs = PostprocessGermlineCNVCalls.genotyped_intervals_vcf,
            genotyped_intervals_vcf_indexes = PostprocessGermlineCNVCalls.genotyped_intervals_vcf_index,
            genotyped_segments_vcfs = PostprocessGermlineCNVCalls.genotyped_segments_vcf,
            genotyped_segments_vcf_indexes = PostprocessGermlineCNVCalls.genotyped_segments_vcf_index,
    }
    ...
    output {
        ...
        Array[String] genotyped_intervals_vcfs = data_transfer.genotyped_intervals_vcfs_path
        Array[String] genotyped_intervals_vcf_indexes = data_transfer.genotyped_intervals_vcf_indexes_path
        Array[String] genotyped_segments_vcfs = data_transfer.genotyped_segments_vcfs_path
        Array[String] genotyped_segments_vcf_indexes = data_transfer.genotyped_segments_vcf_indexes_path
    }
}
...
task data_transfer {
    input {
        String sample_id
        String bucket_url
        Array[File] genotyped_intervals_vcfs
        Array[File] genotyped_intervals_vcf_indexes
        Array[File] genotyped_segments_vcfs
        Array[File] genotyped_segments_vcf_indexes
    ...
    command <<<
        ...
        gsutil -m cp ${file} ~{bucket_url}/~{sample_id}/genotyped_intervals_vcfs/
        echo "~{bucket_url}/~{sample_id}/genotyped_intervals_vcfs/$(basename ${file})" >> genotyped_intervals_vcfs_gs_urls.txt
        done

        echo -e "\n=== Sending Genotyped Intervals VCF Indexes ===\n"

        for file in ~{sep=" " genotyped_intervals_vcf_indexes}; do
        gsutil -m cp ${file} ~{bucket_url}/~{sample_id}/genotyped_intervals_vcf_indexes/
        echo "~{bucket_url}/~{sample_id}/genotyped_intervals_vcf_indexes/$(basename ${file})" >> genotyped_intervals_vcf_indexes_gs_urls.txt
        done

        echo -e "\n=== Sending Genotyped Segments VCF ===\n"

        for file in ~{sep=" " genotyped_segments_vcfs}; do
        gsutil -m cp ${file} ~{bucket_url}/~{sample_id}/genotyped_segments_vcfs/
        echo "~{bucket_url}/~{sample_id}/genotyped_segments_vcfs/$(basename ${file})" >> genotyped_segments_vcfs_gs_urls.txt
        done

        echo -e "\n=== Sending Genotyped Segments VCF Indexes ===\n"

        for file in ~{sep=" " genotyped_segments_vcf_indexes}; do
        gsutil -m cp ${file} ~{bucket_url}/~{sample_id}/genotyped_segments_vcf_indexes/
        echo "~{bucket_url}/~{sample_id}/genotyped_segments_vcf_indexes/$(basename ${file})" >> genotyped_segments_vcf_indexes_gs_urls.txt
        done

    >>>

    output {
        Array[String] genotyped_intervals_vcfs_path = read_lines("genotyped_intervals_vcfs_gs_urls.txt")
        Array[String] genotyped_intervals_vcf_indexes_path = read_lines("genotyped_intervals_vcf_indexes_gs_urls.txt")
        Array[String] genotyped_segments_vcfs_path = read_lines("genotyped_segments_vcfs_gs_urls.txt")
        Array[String] genotyped_segments_vcf_indexes_path = read_lines("genotyped_segments_vcf_indexes_gs_urls.txt")
    }
